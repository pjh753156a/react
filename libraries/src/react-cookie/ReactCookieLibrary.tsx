...
export default function ReactCookieLibrary() 
{
    ...
    const onRegistButtonClickHandler = () => {
        ...
        // setCookie 함수는 첫번째 매개변수로 name 값 / 두번째 매개변수로 value 값/
        // 세번째 매개변수로 option 지정
        // option:
        // - path : 쿠키를 사용할 수 있는 경로
        // - expires : 쿠키 만료 기간
        setCookie(key,value,{path:'/0'});
    }

    const onRemoveButtonClickHandler = () => {
        // removeCookie 함수는 첫번째 매개변수로 name 값/ 두 번째 매개변수 option 지정
        removeCookie(key,{path:'/2'});
    }
